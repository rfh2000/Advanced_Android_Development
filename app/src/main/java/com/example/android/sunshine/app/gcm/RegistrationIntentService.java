...
/**
 * Created by lecoq on 06/01/2016.
 */
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        try {
            ...
            synchronized (TAG) {
                ...
                // https://github.com/udacity/Advanced_Android_Development/blob/5.03_Registering_with_GCM/app/src/main/java/com/example/android/sunshine/app/gcm/RegistrationIntentService.java
...
//                }
                ...
                // Note this is not actually sending anything
                sendRegistrationToServer(token);
